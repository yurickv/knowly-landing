    ...
    <section id="solution" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4 fade-in-section opacity-0">
            Рішення, яке працює
          </h2>
          <p className="text-xl text-gray-600 text-center mb-12 fade-in-section opacity-0">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {solutions.map((item, index) => (
              <Card
                key={index}
                className="border-blue-200 hover:border-blue-400 transition-all duration-300 hover:shadow-lg fade-in-section opacity-0"
